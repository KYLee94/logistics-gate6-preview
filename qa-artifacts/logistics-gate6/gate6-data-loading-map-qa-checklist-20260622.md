...
| [ ] | 배포 후 실제 URL smoke를 Playwright로 확인해야 함 | `dist/**`, GitHub Pages live deployment | `npm run qa:data-loading:stability -- --base-url https://kylee94.github.io/logistics-gate6-preview/ --cache-bust`; `npm run qa:market-data:browser -- --base-url https://kylee94.github.io/logistics-gate6-preview/ --cache-bust`; `npm run qa:legacy-intro:block -- --base-url https://kylee94.github.io/logistics-gate6-preview/ --cache-bust` | Pending after deploy | QA/Release pending - live smoke only after deployment |
