        ...
        kr: {
            ...
            subtitle: (
                <>
                    ...
                    가장 핵심적인 '데이터 기반 확보'와 '기업용 AI 도입'은 순차적이 아닌 Parallel로 동시 진행된다.
                </>
            ),
            box1: {
                title: "1. 플랫폼",
                desc: (
                    <>
                        Priority가 높은 핵심 프로젝트 우선순위로 그룹 내 정보를 취합하고, 단계별/섹터별 대시보드를 점진적으로 구축한다.<br />
            ...
            box2: {
                title: "2. AI 시스템 도입",
                desc: "빅테크 AI 벤더사(OpenAI, 구글 등)와의 전략적 제휴를 맺는다. 단순 개발을 넘어 공식 MOU 및 론칭을 통해 이지스의 '선진 기술 도입'과 '시스템 투명성'을 투자자들에게 각인시켜 신뢰도를 높이는 강력한 대외 홍보 수단으로 활용한다.",
                bullets: [
