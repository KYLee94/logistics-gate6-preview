        ...
        <div className="w-full flex flex-col pt-[77px] pb-[160px] max-w-[1112px] mx-auto">
            ...
            <div className="flex flex-col w-full mb-[32px]">
                ...
                <div className="flex flex-col">
                    <h3 className="text-[20px] font-bold text-[#7da2fb] mb-[6px]">1. 단일 진실의 원칙(Single Source of Truth)</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[20px] font-bold text-[#7da2fb] mb-[6px]">2. 결정자·승인자 분리 원칙(Two-Lock)</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[20px] font-bold text-[#7da2fb] mb-[6px]">3. UW 범위 안과 밖의 분리 원칙</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[20px] font-bold text-[#7da2fb] mb-[6px]">4. 이해상충 방화벽 원칙</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[20px] font-bold text-[#7da2fb] mb-[6px]">5. 기록과 복기의 원칙</h3>
