...
{/* 2. Task 관리 */}
            ...
            <div className="flex justify-between items-center mb-[10px]">
                <div className="flex items-center gap-0">
                    ...
                    <a href={`${import.meta.env.BASE_URL}platform/iotaseoul/workspace/archive?workspace=pm`} target="_blank" rel="noopener noreferrer" className="text-[#86868B] hover:text-[#3b82f6] text-[13px] font-bold ml-[18px] mt-[2px]  transition-colors flex items-center gap-[3px] cursor-pointer">
                        지난 테스크 보기
