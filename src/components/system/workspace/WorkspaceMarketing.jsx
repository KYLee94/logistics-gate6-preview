                ...
                <table className="w-full text-left table-fixed">
                    <thead>
                        <tr>
                            ...
                            <th className="pl-[16px] pr-[22px] py-[16px] text-[13px] font-bold text-[#86868B] border-b border-[#3c3c3c] w-[11%] text-right">마감일</th>
                        ...
                        {isLoading ? (
                            ...
                            (projectShowAll ? tasks : tasks.slice(0, 5)).map((row) => (
                                <tr key={row.id} className="hover:bg-[#272726] transition-colors group">
                                    ...
                                    <td className="pl-[16px] pr-[22px] py-[16px] text-[13px] text-[#A1A1AA] font-['Inter'] text-right">{row.due_date}</td>
