                                ...
                                <React.Fragment key={`node-${i}`}>
                                    ...
                                    >
                                        <div className="origin-center" style={{ animation: 'orbitSpinReverse 60s linear infinite' }}>
                                            <div className="text-[13px] lg:text-[15px] font-bold text-[#1d1d1f] whitespace-nowrap leading-none tracking-tight bg-white/40 backdrop-blur-md border border-gray-200/80 px-4 py-2 lg:px-5 lg:py-2.5 rounded-[10px] shadow-[0_4px_16px_rgba(0,0,0,0.06)]" 
