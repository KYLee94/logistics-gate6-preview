        ...
        const nextAction = (e) => {
            if (e.type === 'appSlideNext') {
                if (stepRef.current === 4) {
                    ...
                    setTimeout(() => setStep(7), 3500); // Trigger lateral fragmentation into 30 isolated boxes
                }
            }
        };
                ...
                <div className={`w-full overflow-x-auto hide-scrollbar pb-6 transition-all duration-[1500ms] ease-[cubic-bezier(0.19,1,0.22,1)] ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
                    ...
                    {[0, 1, 2].map((rowIndex) => (
                        ...
                        >
                            ...
                            <div 
                                className={`flex items-center min-w-[1000px] xl:min-w-0 w-full transition-all duration-[1200ms] ease-[cubic-bezier(0.19,1,0.22,1)] 
                            ...
                            {stages.map((stage, idx) => (
                                <React.Fragment key={idx}>
                                    ...
                                    >
                                        {/* Top Title Bar */}
                                        <div 
                                            className={`w-full flex items-center justify-center z-20 transition-all duration-[1200ms] 
                                    ...
                                    {idx < stages.length - 1 && (
                                        <div 
                                            className={`bg-gradient-to-b from-[#dc2626] to-[#f97316] shrink-0 z-30 shadow-[0_0_15px_rgba(239,68,68,0.9)] transition-all duration-[1000ms] ease-in-out
