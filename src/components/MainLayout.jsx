...
export default function MainLayout() {
    const slidesLength = 16; // known length
    ...
    const slides = [<Section1 />, <Section2 />, <Section3 />, <Section4 />, <Section5 />, <Section6 />, <Section7 />, <Section8 />, <Section9 />, <Section10 />, <Section11 />, <Section12 />, <Section13 />, <Section14 />, <Section15 />, <Section16 />];

    const [isActionDone, setIsActionDone] = useState(false);

    // Animation durations mapped closely to each page's visual completion timing
    const slideAnimationTimes = [1500, 3600, 4200, 2600, 4200, 2500, 3500, 4000, 4500, 3500, 4500, 10000, 7000, 6000, 5500, 4500];
